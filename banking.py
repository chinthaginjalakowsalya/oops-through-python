class Bank:
    def __init__(self):
        self.accounts={}
    def create_acoount(self,account_number,account_holder,initial balance)
        if account_number in self.accounts:
            return "Account already exists"
        if initial_balance < 0:
            return "Initial balance must be non-negitive"
    ...
    def deposit(self,account_number, amount):
        ...
        return "Deposited" + str(amount) + "successfully.
    New balance : " + str(self.accounts[account_number]['balance'])
    def withdraw(self,accoumt_number, amount):
        if account_number not in self.accounts:
            return "Account does not exist"
        if amount <= 0:
        ...
        self.accounts[account_number]['balance'] -= amount
        return "withdrew" + str(amount) + " successfully.New balance : " + s
